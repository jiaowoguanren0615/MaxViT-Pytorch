<h1 align='center'>Multi-Axis Vision Transformer (MaxViT)</h1>

# [MaxViT: Multi-Axis Vision Transformer (ECCV 2022)](https://arxiv.org/abs/2204.01697)
...
├── models: MaxViT Model
    ├── build_models.py: Construct MaxViT models
├── util:
