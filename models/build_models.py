...
@register_model
def max_vit_tiny_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MaxViT:
...
@register_model
def max_vit_small_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MaxViT:
...
@register_model
def max_vit_base_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MaxViT:
...
@register_model
def max_vit_large_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MaxViT:
