...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'MaxViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='max_vit_tiny_224', type=str, metavar='MODEL',
                        choices=['max_vit_base_224', 'max_vit_tiny_224', 'max_vit_large_224', 'max_vit_small_224'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'MaxViT training and evaluation script', parents=[get_args_parser()])
